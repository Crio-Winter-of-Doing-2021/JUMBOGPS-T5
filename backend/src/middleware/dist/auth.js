...
function authByToken(req, res, next) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var authHeader, token, email, e_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    authHeader = (_a = req.header('Authorization')) === null || _a === void 0 ? void 0 : _a.split(' ');
                    if (!authHeader)
                ...
                case 1:
                    _b.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, jwt_1.decode(token)];
                case 2:
                    email = _b.sent();
                    if (!email)
                ...
                case 3:
                    e_1 = _b.sent();
                    return [2 /*return*/, res.status(401).json({
                            errors: { body: ['Authorization failed', e_1.message] }
                        })];
